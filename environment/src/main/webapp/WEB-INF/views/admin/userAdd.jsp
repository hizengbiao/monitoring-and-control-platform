  ...
  <body>
    ...
    <form class="form-horizontal" role="form" style="width: 1000px">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="text" value="" class="form-control" id="phone" placeholder="联系方式">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    <div class="col-sm-offset-3 col-sm-4">
	      <button type="button" id="update" class="btn btn-info btn-block">添加用户</button>
	    </div>
	  </div>
	</form>
	...
	<script type="text/javascript">
		$("#update").click(function () {
			...
			$.ajax({
				url: '<%=path%>/admin/userAdd.do' ,
				method: 'POST' ,
				async: false ,
				data: {username:username, name:name, phone:phone, password:password, baseId:baseId} ,
				dataType: 'JSON' ,
