  ...
  <body>
    ...
    <form class="form-horizontal" role="form" style="width: 1000px">
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="text" value="<%=corp.getName() %>" class="form-control" id="name" placeholder="作物名称">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="text" value="<%=corp.getCode() %>" class="form-control"  id="code" placeholder="作物编码">
	    </div>
	  </div>
...
<!--     </div> container -->
	...
	<script type="text/javascript">
		$("#update").click(function () {
			...
			$.ajax({
				url: '<%=path%>/admin/corpEdit.do' ,
				method: 'POST' ,
				async: false ,
				data: {id:<%=corp.getId()%>, name:name, code:code} ,
				dataType: 'JSON' ,
