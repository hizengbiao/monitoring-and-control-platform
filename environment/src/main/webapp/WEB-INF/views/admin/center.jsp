  ...
  <body>
    ...
    <form class="form-horizontal" role="form" style="width: 1000px">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="text" class="form-control" value="<%=admin.getName() %>" id="name" placeholder="姓名">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="text" class="form-control" value="<%=admin.getPhone() %>" id="phone" placeholder="联系方式">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="password" class="form-control" value="<%=admin.getPassword() %>" id="password" placeholder="密码">
	    </div>
	  </div>
...
<!--     </div> container -->
	...
	<script type="text/javascript">
		$("#update").click(function () {
			...
			$.ajax({
				url: '<%=path%>/admin/center.do' ,
				method: 'POST' ,
				async: false ,
				data: {id:<%=admin.getId()%>, name:name, phone:phone, password: password} ,
				dataType: 'JSON' ,
